...
api_base = "http://127.0.0.1:2028" # 后端服务基础地址
api_endpoint = f"{api_base}/v1/video/generation" # 图像生成接口路径
model_name = "wan2_2" # 模型名，需与后端支持的模型匹配（flux-schnell/flux-dev）
...
def test_image_generation():
        ...
        try:
                ...
                image_b64 = image_to_base64("/export/home/weinan5/zjs/wan/Wan2.2/examples/i2v_input.JPG")
                ...
                elif image_result.get("video"):
                        print(f"尺寸: {image_result.get('width')}x{image_result.get('height')}, 帧数: {image_result.get('num_frames')}")
                        base64_to_image(image_result['video'], "./result.mp4")
