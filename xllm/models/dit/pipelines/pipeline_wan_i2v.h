 ...
 private:
  ...
  torch::Tensor forward_impl(
    ...
    if (dit_config.rainfusion_enabled()) {
      ...
      rf_config.version = dit_config.rainfusion_version();
      rf_config.mask_refresh_steps = dit_config.rainfusion_mask_refresh_steps();
    ...
    torch::save(video, "./vae_decode_output.pt");
