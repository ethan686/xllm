...
void NpuMistralDecoderLayerImpl::param_from_args(
    atb_speed::mistral::DecoderLayerParam& param,
...
NpuMistralDecoderLayerImpl::NpuMistralDecoderLayerImpl(
  ...
  loader_ = std::make_unique<MistralDecoderLoader>(WEIGHT_COUNT_PER_LAYER,
                                                       context);
}
...
int64_t NpuMistralDecoderLayerImpl::init_node(
  ...
  atb_speed::qwen::Mistral_DecoderLayer(param, &operation);
